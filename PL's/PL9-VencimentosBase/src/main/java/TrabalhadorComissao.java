...
public class TrabalhadorComissao extends Trabalhador {
    ...
    /**
     * A percentagem por omissão da comissão de vendas do trabalhador à
     * comissão.
     */
    ...
    /**
     * Constrói uma instância de TrabalhadorComissão recebendo o nome, o salário
    ...
    /**
     * Constrói uma instância de TrabalhadorComissão recebendo o nome e
    ...
    /**
     * Constrói uma instância de TrabalhadorComissão atribuindo o nome por
     ...
     *
     * @param comissao a nova percentagem da comissão de vendas do trabalhador à
     *                 comissão
     */
